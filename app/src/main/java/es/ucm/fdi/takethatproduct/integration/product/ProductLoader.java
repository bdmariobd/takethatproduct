...
public class ProductLoader extends AsyncTaskLoader<List<Product>> {
    ...
    public ProductLoader(Context context, String searchField) {
        super(context);
    ...
    public List<Product> loadInBackground() {
        Log.d(this.getClass().getSimpleName(), "Loading products. Search field : " + searchField);
        try{
            return ApiUtil.getProductsFromUrl(searchField);
        }
        catch (Exception e){
